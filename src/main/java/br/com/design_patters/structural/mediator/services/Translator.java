package main.java.br.com.design_patters.structural.mediator.services;

import java.util.HashMap;
import java.util.Map;

import main.java.br.com.design_patters.structural.mediator.model.Language;
...
public class Translator {
  ...
  public String getTranslation(
    ...
    if (senderLanguage == Language.PORTUGUESE) return (
        porToEng.get(message) != null
      )
      ? porToEng.get(message)
      : message; else return engToPor.get(message) != null
      ? engToPor.get(message)
      : message;
  }
}
