package main.java.br.com.design_patters.behavioral.template;

import java.util.Arrays;

import main.java.br.com.design_patters.behavioral.template.model.Buyer;
...
import main.java.br.com.design_patters.behavioral.template.model.Product;
import main.java.br.com.design_patters.behavioral.template.service.BestOfferService;
...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    Cart cart1 = new Cart(
      simpleBuyer1,
      Arrays.asList(notebook, shoes, shorts, mouse)
    );
    Cart cart2 = new Cart(
      simpleBuyer2,
      Arrays.asList(notebook, shoes, shorts, mouse)
