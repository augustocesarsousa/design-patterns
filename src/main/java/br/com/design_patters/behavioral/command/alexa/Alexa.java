package main.java.br.com.design_patters.behavioral.command.alexa;

import java.util.HashMap;
import java.util.Map;

import main.java.br.com.design_patters.behavioral.command.commands.Command;
...
public class Alexa {
  ...
  public void sendRequest(String request) {
    ...
    System.out.println(
      "Send a generic command as you saved in my configurations"
    );
    command.execute();
  }
}
