package main.java.br.com.design_patters.behavioral.memento;
...
import main.java.br.com.design_patters.behavioral.memento.component.TextAreaWithMemory;
import main.java.br.com.design_patters.behavioral.memento.component.TextAreaWithMemory.TextAreaMemento;
import main.java.br.com.design_patters.behavioral.memento.memory.Caretaker;
...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    mementosList.addItemListener(e -> {
      originator.restore(
        (TextAreaMemento) caretaker.get(mementosList.getSelectedIndex())
      );
      originator.requestFocusInWindow();
    });
